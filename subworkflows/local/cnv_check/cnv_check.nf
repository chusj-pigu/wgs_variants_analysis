...
workflow CNV_CHECK {
    ...
    */
    ...
    ch_section_description = channel.value("CNV profiles generated by QDNAseq for each sample. The plots show the normalized read counts across the genome, highlighting regions of copy number gains and losses. Window = " + params.qdnaseq_binsize + "kb.")
